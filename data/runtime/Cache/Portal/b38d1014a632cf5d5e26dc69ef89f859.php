<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
	...
	<style>
		...
		<link href="/yscy/themes/simplebootx/Public/assets/css/slippry/slippry.css" rel="stylesheet">
		<style>
...
<div class="navbar navbar-fixed-top">
   <div class="navbar-inner">
     <div class="container">
       ...
       <a class="brand" href="/yscy/"><img src="/yscy/themes/simplebootx/Public/assets/images/logo.png"/></a>
				...
				<div class="header">
					<div class="item-image">
						<a href="<?php echo leuu('article/index',array('id'=>$vo['object_id'],'cid'=>$vo['term_id']));?>">
							<?php if(empty($smeta['thumb'])): ?><img src="/yscy/themes/simplebootx/Public/assets/images/default_tupian1.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
							<?php else: ?> 
...
<script src="/yscy/themes/simplebootx/Public/assets/js/slippry.min.js"></script>
<script>
$(function() {
