...
<body>
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td><input type="text" name="post[post_source]" id="source" value="" style="width: 400px" placeholder="请输入文章来源"></td>
                                                ...
                                                <tr>
							<th>文章链接</th>
							<td><input type="text" name="post[post_linker]" id="linker" value="" style="width: 400px" placeholder="请输入文章链接"></td>
						</tr>
                                                 <tr>
							<th>文章作者</th>
							<td><input type="text" name="post[post_zuozhe]" id="zuozhe" value="" style="width: 400px" placeholder="请输入文章作者"></td>
						</tr>
						<tr>
							<th>摘要</th>
							<td>
							...
							<td>
								<div style="text-align: center;">
									...
									<a href="javascript:upload_one_image('图片上传','#thumb');">
										<img src="/yscy/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png" id="thumb-preview" width="135" style="cursor: hand" />
									</a>
									<input type="button" class="btn btn-small" onclick="$('#thumb-preview').attr('src','/yscy/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png');$('#thumb').val('');return false;" value="取消图片">
								</div>
							</td>
						</tr>
						<tr>
	...
	<script type="text/javascript" src="/yscy/public/js/ueditor/ueditor.config.js"></script>
	<script type="text/javascript" src="/yscy/public/js/ueditor/ueditor.all.min.js"></script>
	<script type="text/javascript">
		$(function() {
